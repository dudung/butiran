/*
	...
	0549 Start to integrate to butiran.min.js lib.
	0653 Change matrixPixelSize to Display.matrixPixelSize.
	20200605
	0813 Add if compile at the end.
*/
...
function paintMatrix() {
	...
	var o = {
		onCanvas: function() {
			...
			var dx = Display.matrixPixelSize;
			var dy = Display.matrixPixelSize;
...
// Export module -- 20200703.0618
if(butiran == "compile") {
	module.exports = {
		matrixPixelSize: matrixPixelSize,
		matrixColor: matrixColor,
		paintMatrix: function(m) {
			return paintMatrix(m);
		},
	};
}
