+++
title = 'learning obe-ga-clo'
date = '2025-06-29T05:34:55+07:00'
authors = ['viridi']
draft = false
type = 'notes'
tags = ['obe', 'clo']
...
Some information about outcome-based education [^siddiqui_2023]:
...
## graduate attributes
In Australia, generic graduate attributes are defined and expected as key outcomes of university education [^barrie_2004]:
- Generic graduate attributes have come to be accepted as being the skills, knowledge and abilities of university graduates, beyond disciplinary content knowledge, which are applicable to a range of contexts.
- These qualities are intended to be acquired by university students as one of the outcomes of successfully completing any undergraduate degree at university.


## gga key features
There are key features defining generic graduate attributes [^barrie_2004]:
- Generic graduate attributes are developed across all fields of study.
- They describe what a graduate is expected to gain from university learning.
- These attributes go beyond basic skills, covering broader knowledge and values.
- They emerge naturally from the process of higher education, not from extra courses.


## penyusunan dokumen kurikulum
Terdapat tiga tahapan dalam penyusunan dokumen kurikulum [^kusumawardani_2025]:
- Tahapan perancangan dokumen kurikulum.
- Tahapan perancangan pembelajaran.
- Tahapan evaluasi program pembelajaran.


## tujuan program studi
Beberapa penjelasan terkait dengan tujuan program studi [^kusumawardani_2025]:
- Tujuan Program Studi (TPS) memiliki istilah lain Program Educational Objective (PEO).
- TPS menggambarkan karir dan profesi apa yang dapat
dicapai setelah mahasiswa lulus.
- Penetapan TPS merupakan bagian dari Tahap Perancangan Dokumen Kurikulum.


## profil lulusan
Beberapa penjelasan mengenai profil lulusan adalah [^kusumawardani_2025]:
...
- Profil lulusan dirumuskan oleh program studi berdasarkan hasil penelusuran lulusan, masukan pemangku kepentingan, asosiasi profesi, konsorsium keilmuan, kecenderungan perkembangan keilmuan / keahlian ke depan, dan dari hasil evaluasi kurikulum.
