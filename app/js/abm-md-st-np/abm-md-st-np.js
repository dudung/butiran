/*
	...
	for simulating stem cell deposited on nanopattern
	...
	20210109
	0948 Rename from abm-md.js to abm-md-st-pn.js for consistency.
	0957 Add Display. for paintMatrix() function.
...
function main() {
	...
	btnRead.addEventListener("click", function() {
		...
		Display.paintMatrix(world).onCanvas("can");
		if(!DRAW_GRID_LAST) {
